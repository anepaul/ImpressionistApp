...
public class ImageViewTouch extends ImageViewTouchBase {
    ...
    private OnImageUpdateListener mImageUpdateListener;
    ...
    public void setImageUpdateListener(OnImageUpdateListener listener) {
        mImageUpdateListener = listener;
    }
    ...
    private void fireOnImageUpdated() {
        if (mImageUpdateListener != null) {
            mImageUpdateListener.onImageUpdated(getImageMatrix());
        }
    }
    ...
    public interface OnImageUpdateListener {
        void onImageUpdated(Matrix matrix);
    }
